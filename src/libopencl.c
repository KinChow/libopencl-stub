...
cl_int clGetPlatformIDs(cl_uint num_entries, cl_platform_id *platforms,
  ...
  func = (f_clGetPlatformIDs)LoadFunc(so_handle, "clGetPlatformIDs");
  if (func) {
...
cl_int clGetPlatformInfo(cl_platform_id platform, cl_platform_info param_name,
  ...
  func = (f_clGetPlatformInfo)LoadFunc(so_handle, "clGetPlatformInfo");
  if (func) {
...
cl_int clGetDeviceIDs(cl_platform_id platform, cl_device_type device_type,
  ...
  func = (f_clGetDeviceIDs)LoadFunc(so_handle, "clGetDeviceIDs");
  if (func) {
...
cl_int clGetDeviceInfo(cl_device_id device, cl_device_info param_name,
  ...
  func = (f_clGetDeviceInfo)LoadFunc(so_handle, "clGetDeviceInfo");
  if (func) {
...
cl_int clCreateSubDevices(cl_device_id in_device,
  ...
  func = (f_clCreateSubDevices)LoadFunc(so_handle, "clCreateSubDevices");
  if (func) {
...
cl_int clRetainDevice(cl_device_id device) {
  ...
  func = (f_clRetainDevice)LoadFunc(so_handle, "clRetainDevice");
  if (func) {
    return func(device);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clReleaseDevice(cl_device_id device) {
  ...
  func = (f_clReleaseDevice)LoadFunc(so_handle, "clReleaseDevice");
  if (func) {
    return func(device);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_context clCreateContext(const cl_context_properties *properties,
  ...
  func = (f_clCreateContext)LoadFunc(so_handle, "clCreateContext");
  if (func) {
...
cl_context clCreateContextFromType(
  ...
  func =
      (f_clCreateContextFromType)LoadFunc(so_handle, "clCreateContextFromType");
  if (func) {
...
cl_int clRetainContext(cl_context context) {
  ...
  func = (f_clRetainContext)LoadFunc(so_handle, "clRetainContext");
  if (func) {
    return func(context);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clReleaseContext(cl_context context) {
  ...
  func = (f_clReleaseContext)LoadFunc(so_handle, "clReleaseContext");
  if (func) {
    return func(context);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clGetContextInfo(cl_context context, cl_context_info param_name,
  ...
  func = (f_clGetContextInfo)LoadFunc(so_handle, "clGetContextInfo");
  if (func) {
...
cl_command_queue clCreateCommandQueue(cl_context context, cl_device_id device,
  ...
  func = (f_clCreateCommandQueue)LoadFunc(so_handle, "clCreateCommandQueue");
  if (func) {
...
clCreateCommandQueueWithProperties(cl_context context, cl_device_id device,
  ...
  func = (f_clCreateCommandQueueWithProperties)LoadFunc(
...
cl_int clRetainCommandQueue(cl_command_queue command_queue) {
  ...
  func = (f_clRetainCommandQueue)LoadFunc(so_handle, "clRetainCommandQueue");
  if (func) {
...
cl_int clReleaseCommandQueue(cl_command_queue command_queue) {
  ...
  func = (f_clReleaseCommandQueue)LoadFunc(so_handle, "clReleaseCommandQueue");
  if (func) {
    return func(command_queue);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clGetCommandQueueInfo(cl_command_queue command_queue,
  ...
  func = (f_clGetCommandQueueInfo)LoadFunc(so_handle, "clGetCommandQueueInfo");
  if (func) {
...
cl_mem clCreateBuffer(cl_context context, cl_mem_flags flags, size_t size,
  ...
  func = (f_clCreateBuffer)LoadFunc(so_handle, "clCreateBuffer");
  if (func) {
...
cl_mem clCreateSubBuffer(cl_mem buffer, cl_mem_flags flags,
  ...
  func = (f_clCreateSubBuffer)LoadFunc(so_handle, "clCreateSubBuffer");
  if (func) {
...
cl_mem clCreateImage(cl_context context, cl_mem_flags flags,
  ...
  func = (f_clCreateImage)LoadFunc(so_handle, "clCreateImage");
  if (func) {
...
cl_int clRetainMemObject(cl_mem memobj) {
  ...
  func = (f_clRetainMemObject)LoadFunc(so_handle, "clRetainMemObject");
  if (func) {
    return func(memobj);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clReleaseMemObject(cl_mem memobj) {
  ...
  func = (f_clReleaseMemObject)LoadFunc(so_handle, "clReleaseMemObject");
  if (func) {
    return func(memobj);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clGetSupportedImageFormats(cl_context context, cl_mem_flags flags,
  ...
  func = (f_clGetSupportedImageFormats)LoadFunc(so_handle,
...
cl_int clGetMemObjectInfo(cl_mem memobj, cl_mem_info param_name,
  ...
  func = (f_clGetMemObjectInfo)LoadFunc(so_handle, "clGetMemObjectInfo");
  if (func) {
...
cl_int clGetImageInfo(cl_mem image, cl_image_info param_name,
  ...
  func = (f_clGetImageInfo)LoadFunc(so_handle, "clGetImageInfo");
  if (func) {
...
cl_int clSetMemObjectDestructorCallback(cl_mem memobj,
  ...
  func = (f_clSetMemObjectDestructorCallback)LoadFunc(
...
cl_sampler clCreateSampler(cl_context context, cl_bool normalized_coords,
  ...
  func = (f_clCreateSampler)LoadFunc(so_handle, "clCreateSampler");
  if (func) {
...
cl_int clRetainSampler(cl_sampler sampler) {
  ...
  func = (f_clRetainSampler)LoadFunc(so_handle, "clRetainSampler");
  if (func) {
    return func(sampler);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clReleaseSampler(cl_sampler sampler) {
  ...
  func = (f_clReleaseSampler)LoadFunc(so_handle, "clReleaseSampler");
  if (func) {
    return func(sampler);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clGetSamplerInfo(cl_sampler sampler, cl_sampler_info param_name,
  ...
  func = (f_clGetSamplerInfo)LoadFunc(so_handle, "clGetSamplerInfo");
  if (func) {
...
cl_program clCreateProgramWithSource(cl_context context, cl_uint count,
  ...
  func = (f_clCreateProgramWithSource)LoadFunc(so_handle,
...
cl_program clCreateProgramWithBinary(cl_context context, cl_uint num_devices,
  ...
  func = (f_clCreateProgramWithBinary)LoadFunc(so_handle,
...
cl_program clCreateProgramWithBuiltInKernels(cl_context context,
  ...
  func = (f_clCreateProgramWithBuiltInKernels)LoadFunc(
...
cl_int clRetainProgram(cl_program program) {
  ...
  func = (f_clRetainProgram)LoadFunc(so_handle, "clRetainProgram");
  if (func) {
    return func(program);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clReleaseProgram(cl_program program) {
  ...
  func = (f_clReleaseProgram)LoadFunc(so_handle, "clReleaseProgram");
  if (func) {
    return func(program);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clBuildProgram(cl_program program, cl_uint num_devices,
  ...
  func = (f_clBuildProgram)LoadFunc(so_handle, "clBuildProgram");
  if (func) {
...
cl_int clCompileProgram(cl_program program, cl_uint num_devices,
  ...
  func = (f_clCompileProgram)LoadFunc(so_handle, "clCompileProgram");
  if (func) {
...
clLinkProgram(cl_context context, cl_uint num_devices,
  ...
  func = (f_clLinkProgram)LoadFunc(so_handle, "clLinkProgram");
  if (func) {
...
cl_int clUnloadPlatformCompiler(cl_platform_id platform) {
  ...
  func = (f_clUnloadPlatformCompiler)LoadFunc(so_handle,
...
cl_int clGetProgramInfo(cl_program program, cl_program_info param_name,
  ...
  func = (f_clGetProgramInfo)LoadFunc(so_handle, "clGetProgramInfo");
  if (func) {
...
cl_int clGetProgramBuildInfo(cl_program program, cl_device_id device,
  ...
  func = (f_clGetProgramBuildInfo)LoadFunc(so_handle, "clGetProgramBuildInfo");
  if (func) {
...
cl_kernel clCreateKernel(cl_program program, const char *kernel_name,
  ...
  func = (f_clCreateKernel)LoadFunc(so_handle, "clCreateKernel");
  if (func) {
...
cl_int clCreateKernelsInProgram(cl_program program, cl_uint num_kernels,
  ...
  func = (f_clCreateKernelsInProgram)LoadFunc(so_handle,
...
cl_int clRetainKernel(cl_kernel kernel) {
  ...
  func = (f_clRetainKernel)LoadFunc(so_handle, "clRetainKernel");
  if (func) {
    return func(kernel);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clReleaseKernel(cl_kernel kernel) {
  ...
  func = (f_clReleaseKernel)LoadFunc(so_handle, "clReleaseKernel");
  if (func) {
    return func(kernel);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clSetKernelArg(cl_kernel kernel, cl_uint arg_index, size_t arg_size,
  ...
  func = (f_clSetKernelArg)LoadFunc(so_handle, "clSetKernelArg");
  if (func) {
...
cl_int clGetKernelInfo(cl_kernel kernel, cl_kernel_info param_name,
  ...
  func = (f_clGetKernelInfo)LoadFunc(so_handle, "clGetKernelInfo");
  if (func) {
...
cl_int clGetKernelArgInfo(cl_kernel kernel, cl_uint arg_indx,
  ...
  func = (f_clGetKernelArgInfo)LoadFunc(so_handle, "clGetKernelArgInfo");
  if (func) {
...
cl_int clGetKernelWorkGroupInfo(cl_kernel kernel, cl_device_id device,
  ...
  func = (f_clGetKernelWorkGroupInfo)LoadFunc(so_handle,
...
cl_int clWaitForEvents(cl_uint num_events, const cl_event *event_list) {
  ...
  func = (f_clWaitForEvents)LoadFunc(so_handle, "clWaitForEvents");
  if (func) {
...
cl_int clGetEventInfo(cl_event event, cl_event_info param_name,
  ...
  func = (f_clGetEventInfo)LoadFunc(so_handle, "clGetEventInfo");
  if (func) {
...
cl_event clCreateUserEvent(cl_context context, cl_int *errcode_ret) {
  ...
  func = (f_clCreateUserEvent)LoadFunc(so_handle, "clCreateUserEvent");
  if (func) {
...
cl_int clRetainEvent(cl_event event) {
  ...
  func = (f_clRetainEvent)LoadFunc(so_handle, "clRetainEvent");
  if (func) {
    return func(event);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clReleaseEvent(cl_event event) {
  ...
  func = (f_clReleaseEvent)LoadFunc(so_handle, "clReleaseEvent");
  if (func) {
    return func(event);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clSetUserEventStatus(cl_event event, cl_int execution_status) {
  ...
  func = (f_clSetUserEventStatus)LoadFunc(so_handle, "clSetUserEventStatus");
  if (func) {
...
cl_int clSetEventCallback(cl_event event, cl_int command_exec_callback_type,
  ...
  func = (f_clSetEventCallback)LoadFunc(so_handle, "clSetEventCallback");
  if (func) {
...
cl_int clGetEventProfilingInfo(cl_event event, cl_profiling_info param_name,
  ...
  func =
      (f_clGetEventProfilingInfo)LoadFunc(so_handle, "clGetEventProfilingInfo");
  if (func) {
    return func(event, param_name, param_value_size, param_value,
                param_value_size_ret);
  } else {
...
cl_int clFlush(cl_command_queue command_queue) {
  ...
  func = (f_clFlush)LoadFunc(so_handle, "clFlush");
  if (func) {
    return func(command_queue);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clFinish(cl_command_queue command_queue) {
  ...
  func = (f_clFinish)LoadFunc(so_handle, "clFinish");
  if (func) {
    return func(command_queue);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clEnqueueReadBuffer(cl_command_queue command_queue, cl_mem buffer,
  ...
  func = (f_clEnqueueReadBuffer)LoadFunc(so_handle, "clEnqueueReadBuffer");
  if (func) {
...
clEnqueueReadBufferRect(cl_command_queue command_queue, cl_mem buffer,
  ...
  func =
      (f_clEnqueueReadBufferRect)LoadFunc(so_handle, "clEnqueueReadBufferRect");
  if (func) {
...
cl_int clEnqueueWriteBuffer(cl_command_queue command_queue, cl_mem buffer,
  ...
  func = (f_clEnqueueWriteBuffer)LoadFunc(so_handle, "clEnqueueWriteBuffer");
  if (func) {
...
clEnqueueWriteBufferRect(cl_command_queue command_queue, cl_mem buffer,
  ...
  func = (f_clEnqueueWriteBufferRect)LoadFunc(so_handle,
...
cl_int clEnqueueFillBuffer(cl_command_queue command_queue, cl_mem buffer,
  ...
  func = (f_clEnqueueFillBuffer)LoadFunc(so_handle, "clEnqueueFillBuffer");
  if (func) {
...
cl_int clEnqueueCopyBuffer(cl_command_queue command_queue, cl_mem src_buffer,
  ...
  func = (f_clEnqueueCopyBuffer)LoadFunc(so_handle, "clEnqueueCopyBuffer");
  if (func) {
...
cl_int clEnqueueCopyBufferRect(
  ...
  func =
      (f_clEnqueueCopyBufferRect)LoadFunc(so_handle, "clEnqueueCopyBufferRect");
  if (func) {
    return func(command_queue, src_buffer, dst_buffer, src_origin, dst_origin,
...
cl_int clEnqueueReadImage(cl_command_queue command_queue, cl_mem image,
  ...
  func = (f_clEnqueueReadImage)LoadFunc(so_handle, "clEnqueueReadImage");
  if (func) {
...
cl_int clEnqueueWriteImage(cl_command_queue command_queue, cl_mem image,
  ...
  func = (f_clEnqueueWriteImage)LoadFunc(so_handle, "clEnqueueWriteImage");
  if (func) {
...
cl_int clEnqueueFillImage(cl_command_queue command_queue, cl_mem image,
  ...
  func = (f_clEnqueueFillImage)LoadFunc(so_handle, "clEnqueueFillImage");
  if (func) {
...
cl_int clEnqueueCopyImage(cl_command_queue command_queue, cl_mem src_image,
  ...
  func = (f_clEnqueueCopyImage)LoadFunc(so_handle, "clEnqueueCopyImage");
  if (func) {
...
cl_int clEnqueueCopyImageToBuffer(cl_command_queue command_queue,
  ...
  func = (f_clEnqueueCopyImageToBuffer)LoadFunc(so_handle,
...
cl_int clEnqueueCopyBufferToImage(cl_command_queue command_queue,
  ...
  func = (f_clEnqueueCopyBufferToImage)LoadFunc(so_handle,
...
void *clEnqueueMapBuffer(cl_command_queue command_queue, cl_mem buffer,
  ...
  func = (f_clEnqueueMapBuffer)LoadFunc(so_handle, "clEnqueueMapBuffer");
  if (func) {
...
void *clEnqueueMapImage(cl_command_queue command_queue, cl_mem image,
  ...
  func = (f_clEnqueueMapImage)LoadFunc(so_handle, "clEnqueueMapImage");
  if (func) {
...
cl_int clEnqueueUnmapMemObject(cl_command_queue command_queue, cl_mem memobj,
  ...
  func =
      (f_clEnqueueUnmapMemObject)LoadFunc(so_handle, "clEnqueueUnmapMemObject");
  if (func) {
...
cl_int clEnqueueMigrateMemObjects(cl_command_queue command_queue,
  ...
  func = (f_clEnqueueMigrateMemObjects)LoadFunc(so_handle,
...
cl_int clEnqueueNDRangeKernel(
  ...
  func =
      (f_clEnqueueNDRangeKernel)LoadFunc(so_handle, "clEnqueueNDRangeKernel");
  if (func) {
...
cl_int clEnqueueTask(cl_command_queue command_queue, cl_kernel kernel,
  ...
  func = (f_clEnqueueTask)LoadFunc(so_handle, "clEnqueueTask");
  if (func) {
    return func(command_queue, kernel, num_events_in_wait_list, event_wait_list,
                event);
  } else {
    return CL_INVALID_PLATFORM;
  }
...
cl_int clEnqueueNativeKernel(cl_command_queue command_queue,
  ...
  func = (f_clEnqueueNativeKernel)LoadFunc(so_handle, "clEnqueueNativeKernel");
  if (func) {
...
cl_int clEnqueueMarkerWithWaitList(cl_command_queue command_queue,
  ...
  func = (f_clEnqueueMarkerWithWaitList)LoadFunc(so_handle,
...
cl_int clEnqueueBarrierWithWaitList(cl_command_queue command_queue,
  ...
  func = (f_clEnqueueBarrierWithWaitList)LoadFunc(
...
void *clGetExtensionFunctionAddressForPlatform(cl_platform_id platform,
  ...
  func = (f_clGetExtensionFunctionAddressForPlatform)LoadFunc(
...
cl_mem clCreateImage2D(cl_context context, cl_mem_flags flags,
  ...
  func = (f_clCreateImage2D)LoadFunc(so_handle, "clCreateImage2D");
  if (func) {
...
cl_mem clCreateImage3D(cl_context context, cl_mem_flags flags,
  ...
  func = (f_clCreateImage3D)LoadFunc(so_handle, "clCreateImage3D");
  if (func) {
    return func(context, flags, image_format, image_width, image_height,
...
cl_int clEnqueueMarker(cl_command_queue command_queue, cl_event *event) {
  ...
  func = (f_clEnqueueMarker)LoadFunc(so_handle, "clEnqueueMarker");
  if (func) {
...
cl_int clEnqueueWaitForEvents(cl_command_queue command_queue,
  ...
  func =
      (f_clEnqueueWaitForEvents)LoadFunc(so_handle, "clEnqueueWaitForEvents");
  if (func) {
...
cl_int clEnqueueBarrier(cl_command_queue command_queue) {
  ...
  func = (f_clEnqueueBarrier)LoadFunc(so_handle, "clEnqueueBarrier");
  if (func) {
    return func(command_queue);
  } else {
    return CL_INVALID_PLATFORM;
...
cl_int clUnloadCompiler(void) {
  ...
  func = (f_clUnloadCompiler)LoadFunc(so_handle, "clUnloadCompiler");
  if (func) {
    return func();
  } else {
    return CL_INVALID_PLATFORM;
...
void *clGetExtensionFunctionAddress(const char *func_name) {
  ...
  func = (f_clGetExtensionFunctionAddress)LoadFunc(
...
cl_mem clCreateFromGLBuffer(cl_context context, cl_mem_flags flags,
  ...
  func = (f_clCreateFromGLBuffer)LoadFunc(so_handle, "clCreateFromGLBuffer");
  if (func) {
...
cl_mem clCreateFromGLTexture(cl_context context, cl_mem_flags flags,
  ...
  func = (f_clCreateFromGLTexture)LoadFunc(so_handle, "clCreateFromGLTexture");
  if (func) {
...
cl_mem clCreateFromGLRenderbuffer(cl_context context, cl_mem_flags flags,
  ...
  func = (f_clCreateFromGLRenderbuffer)LoadFunc(so_handle,
...
cl_int clGetGLObjectInfo(cl_mem memobj, cl_gl_object_type *gl_object_type,
  ...
  func = (f_clGetGLObjectInfo)LoadFunc(so_handle, "clGetGLObjectInfo");
  if (func) {
...
cl_int clGetGLTextureInfo(cl_mem memobj, cl_gl_texture_info param_name,
  ...
  func = (f_clGetGLTextureInfo)LoadFunc(so_handle, "clGetGLTextureInfo");
  if (func) {
    return func(memobj, param_name, param_value_size, param_value,
                param_value_size_ret);
  } else {
...
cl_int clEnqueueAcquireGLObjects(cl_command_queue command_queue,
  ...
  func = (f_clEnqueueAcquireGLObjects)LoadFunc(so_handle,
...
cl_int clEnqueueReleaseGLObjects(cl_command_queue command_queue,
  ...
  func = (f_clEnqueueReleaseGLObjects)LoadFunc(so_handle,
...
cl_mem clCreateFromGLTexture2D(cl_context context, cl_mem_flags flags,
  ...
  func =
      (f_clCreateFromGLTexture2D)LoadFunc(so_handle, "clCreateFromGLTexture2D");
  if (func) {
    return func(context, flags, target, miplevel, texture, errcode_ret);
  } else {
    return NULL;
...
cl_mem clCreateFromGLTexture3D(cl_context context, cl_mem_flags flags,
                               cl_GLenum target, cl_GLint miplevel,
                               cl_GLuint texture, cl_int *errcode_ret) {
  ...
  func =
      (f_clCreateFromGLTexture3D)LoadFunc(so_handle, "clCreateFromGLTexture3D");
  if (func) {
    return func(context, flags, target, miplevel, texture, errcode_ret);
  } else {
    return NULL;
...
cl_int clGetGLContextInfoKHR(const cl_context_properties *properties,
  ...
  func = (f_clGetGLContextInfoKHR)LoadFunc(so_handle, "clGetGLContextInfoKHR");
  if (func) {
